 ...
 *
 * Gunakan konfigurasi ini sebagai tema baru tanpa perlu
 * mengubah komponen preview yang sudah ada.
 *
 * Fokus desain:
 * - Hitam & putih
 * - Abu-abu sebagai secondary tone
 * - Silver sebagai aksen
 * - Minimalis
 * - Modern & editorial
 */

export const monochromeConfig: InvitationThemeConfig = {
  id: "monochrome",

  name: "Monochrome",

  colors: {
    // Hitam — hero, footer, section gelap
    primary: "#111111",
  ...
  fonts: {
    // Font script tetap tersedia untuk nama pasangan
  ...
  // Sementara menggunakan musik yang sama
  ...
  couple: {
    ...
    // Untuk sementara gunakan foto yang sama.
    // Nantinya bisa diganti dengan foto khusus tema Monochrome.
