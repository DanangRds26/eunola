 ...
 * - Minimalist & clean
 * - Modern editorial
 * - Black & white sebagai warna utama
 * - Soft gray sebagai secondary tone
 * - Silver sebagai aksen
 * - Banyak whitespace
 * - Typography elegant dan modern
 * - Layout sederhana, refined, dan timeless
 * - Cocok untuk modern, intimate, dan contemporary wedding
 */

export const minimalistConfig: InvitationThemeConfig = {
  id: "minimalist",
  name: "Minimalist",

  colors: {
    // Charcoal black — elemen utama, heading, button
    primary: "#171717",

    // Deep black — hero gelap dan footer
    primaryDark: "#050505",

    // Silver — border, ornament, button
    accent: "#A8A8A8",

    // Soft silver — decorative detail dan background section
    accentSoft: "#D9D9D9",

    // Off-white — background utama
    surface: "#FAFAF9",

    // Near black — text utama
    text: "#1C1C1C",
  ...
  fonts: {
    ...
    // Serif elegant untuk heading
    display: "var(--font-garamond)",

    // Modern sans-serif untuk body
  ...
  couple: {
    ...
    giftAddress:
      "Jl. St Abdurachman, Sei Bangkong Bl E/211, Sungai Bangkong, Kec. Pontianak Kota, Kota Pontianak 78116",
    ...
    // Foto sementara
    // Nantinya dapat diganti dengan foto khusus tema Minimalist
