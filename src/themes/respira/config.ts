 ...
 * - Airy dan calming
 * - Natural luxury
 * - Sage green sebagai warna utama
 * - Deep eucalyptus sebagai warna gelap
 * - Soft peach sebagai aksen hangat
 * - Mist green sebagai secondary tone
 * - Warm cream sebagai background
 * - Typography ringan, natural, dan elegant
 * - Cocok untuk garden, outdoor, intimate, dan modern wedding
 */

export const respiraConfig: InvitationThemeConfig = {
  id: "respira",
  name: "Respira",

  colors: {
    // Sage green — elemen utama, heading, button
    primary: "#668276",

    // Deep eucalyptus — hero gelap dan footer
    primaryDark: "#30463E",

    // Soft peach — accent dan decorative element
    accent: "#C98F78",

    // Mist green — ornament dan background detail
    accentSoft: "#D7E0D9",

    // Warm cream — background utama
    surface: "#F7F4EC",

    // Deep olive charcoal — text utama
    text: "#303A35",

    // Muted eucalyptus gray — secondary text
    textMuted: "#7D8982",
  },
  ...
  fonts: {
    ...
    // Serif ringan dan elegant untuk heading
  ...
  couple: {
    ...
    // Foto sementara
    // Nantinya dapat diganti dengan foto khusus tema Respira
