 ...
 * - Rustic wedding
 * - Natural vintage
 * - Terracotta sebagai warna utama
 * - Dark brown sebagai warna gelap
 * - Antique gold sebagai aksen
 * - Soft beige sebagai secondary tone
 * - Cream sebagai background
 * - Typography klasik, warm, dan elegant
 * - Cocok untuk outdoor, barn, garden, countryside,
 *   intimate, dan vintage wedding
 */

export const rusticConfig: InvitationThemeConfig = {
  id: "rustic",
  name: "Rustic",

  colors: {
    // Terracotta brown — elemen utama, heading, button
    primary: "#8B5E3C",

    // Dark walnut — hero gelap dan footer
    primaryDark: "#3B2920",

    // Antique gold — accent dan decorative element
    accent: "#B58A55",

    // Soft beige — ornament dan background detail
    accentSoft: "#D8C5AD",

    // Warm cream — background utama
    surface: "#F5EBDD",

    // Deep brown — text utama
    text: "#3E3027",
  ...
  couple: {
    ...
    // Foto sementara
    // Nantinya dapat diganti dengan foto khusus tema Rustic
