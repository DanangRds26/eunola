 ...
 *
 * Konsep:
 * - Contemporary & sophisticated wedding
 * - Modern editorial aesthetic
 * - Charcoal sebagai warna utama
 * - Deep black sebagai warna gelap
 * - Warm gold sebagai aksen elegan
 * - Soft taupe sebagai secondary tone
 * - Warm white sebagai background utama
 * - Typography clean, bold, dan refined
 * - Layout minimal, geometric, dan balanced
 * - Cocok untuk modern, intimate, contemporary,
 *   urban, dan luxury wedding
 */

export const modernConfig: InvitationThemeConfig = {
  id: "modern",
  name: "Modern",

  colors: {
    // Charcoal — warna utama, heading, button
    primary: "#252525",

    // Deep black — hero gelap dan footer
    primaryDark: "#0D0D0D",

    // Warm gold — accent dan decorative element
    accent: "#B89B67",

    // Soft taupe — decorative detail dan background section
    accentSoft: "#D8D0C4",

    // Warm white — background utama
    surface: "#F7F6F3",

    // Deep charcoal — text utama
    text: "#242424",

    // Neutral taupe gray — secondary text
    textMuted: "#77736D",
  },
  ...
  couple: {
    ...
    // Foto sementara
    // Nantinya dapat diganti dengan foto khusus tema Modern
