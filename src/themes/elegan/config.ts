...
/**
 * Tema Elegant Monochrome
 *
 * Konsep:
 * - Luxury editorial
 * - Black, ivory, charcoal, silver
 * - Minimalist tetapi sophisticated
 * - Banyak whitespace
 * - Typography sebagai elemen utama
 * - Thin borders dan subtle ornament
 * - Cocok untuk layout modern luxury wedding
 */

export const eleganConfig: InvitationThemeConfig = {
  id: "elegan",
  name: "Elegant",

  colors: {
    // Deep black — hero, footer, dark section
    primary: "#111111",

    // Rich black — overlay dan section premium
    primaryDark: "#050505",

    // Soft silver — border, divider, ornament
    accent: "#A6A6A6",

    // Light silver — background detail dan secondary element
    accentSoft: "#D8D8D8",

    // Warm ivory — background utama
    surface: "#F8F7F4",

    // Charcoal — heading dan text utama
    text: "#181818",
  ...
  fonts: {
    // Script hanya digunakan sebagai aksen nama / signature
    script: "var(--font-script)",

    // Elegant serif untuk heading
    display: "var(--font-garamond)",

    // Clean modern typography untuk body
  ...
  couple: {
    ...
    // Foto sementara
    // Bisa diganti dengan foto khusus Monochrome nantinya
